...
import 'package:pet_house/data.dart';
import 'package:pet_house/pet_widget.dart';
import 'package:pet_house/category_list.dart';
import 'package:pet_house/profile_page.dart';
          ...
          children: [
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      buildPetCategory(
                          Category.CAT, "210", (Colors.blue[200])!),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            ...
            Container(
              ...
              child: PageView(
                physics: BouncingScrollPhysics(),
                children: [
                  buildVet("assets/images/vets/vet_cats_and_dogs.png",
                      "Cats n Dogs Vetrinary Clinic", "(369) 133-8956"),
